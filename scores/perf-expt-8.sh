...
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-8/real_run.log | awk '{print "OP/cycle : " 3987001832*2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-8/real_run.log | awk '{print "GOP/s : " 3987001832*2*0.2/$3}'
