...
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-5/real_run.log | awk '{print "OP/cycle : " 3491339397*2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-5/real_run.log | awk '{print "GOP/s : " 3491339397*2*0.2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-5/real_run.log | awk '{print "DSP efficiency (%) : " 3491339397/$3/1152/2*100}'
