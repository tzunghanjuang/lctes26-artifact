...
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-2/real_run.log | awk '{print "OP/cycle : " 313196544*2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-2/real_run.log | awk '{print "GOP/s : " 313196544*2*0.2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-2/real_run.log | awk '{print "DSP efficiency : " 313196544*2/$3/1152/2}'
