...
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-9/real_run.log | awk '{print "OP/cycle : " 2005750000*2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-9/real_run.log | awk '{print "GOP/s : " 2005750000*2*0.2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-9/real_run.log | awk '{print "DSP efficiency : " 2005750000*2/$3/510/2}'
