...
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-6/real_run.log | awk '{print "OP/cycle : " 2063692800*2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-6/real_run.log | awk '{print "GOP/s : " 2063692800*2*0.2/$3}'
grep -E "required [0-9]+ cycles" $BASEDIR/pre_synthesis_cleaned/expt-6/real_run.log | awk '{print "DSP efficiency : " 2063692800*2/$3/1216/2}'
